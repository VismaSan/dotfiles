...
section "herdr";            bash "$DOTFILES_DIR/scripts/04_herdr.sh"
section "tmux + TPM";       bash "$DOTFILES_DIR/scripts/05_tmux_tpm.sh"
section "nvim";             bash "$DOTFILES_DIR/scripts/06_nvim.sh"
section "Claude settings";  bash "$DOTFILES_DIR/scripts/07_claude.sh"
